...
-- Events
RegisterNetEvent('camera:client:ActiveCamera', function(cameraId)
...
RegisterNetEvent('camera:client:DisableAllCameras', function()
    for k, v in pairs(Config.SecurityCameras.cameras) do 
        Config.SecurityCameras.cameras[k].isOnline = false
    end
end)

RegisterNetEvent('camera:client:EnableAllCameras', function()
    for k, v in pairs(Config.SecurityCameras.cameras) do 
        Config.SecurityCameras.cameras[k].isOnline = true
    end
end)

RegisterNetEvent('camera:client:SetCamera', function(key, isOnline)
